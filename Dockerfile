...
RUN apt-get -qqy update \
    ...
    && wget -cO https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-x64 > visual-studio.deb \
    && apt install -qqy --no-install-recommends ./visual-studio.deb \
    && rm -rf /var/lib/apt/lists/* /var/cache/apt/*
